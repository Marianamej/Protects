...
const fragmentoProductos = renderizadoProductos(productosAMostrar);
...
// Agregar los productos renderizados al contenedor deseado en tu HTML
const contenedorProductos = document.getElementById('productosHomeUltimasUnidades');
